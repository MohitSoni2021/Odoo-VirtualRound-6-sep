...
import { secretKey, expiresIn, OTPexpiresIn } from "../config/jwt.js";
import { generateOTP } from "../utils/generateOTP.js";
import { sendVerificationEmail, sendVerificationEmailSMTP } from "../utils/sendEmail.js";
...
const sendOtp = async (email, name = null) => {
  try {
    ...
    try {
      await sendVerificationEmailSMTP(email, otp, name);
